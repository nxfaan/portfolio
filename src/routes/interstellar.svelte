  ...
  <div class="animate-in">
    <div class="container-fluid full-width">
      <div class="row row-no-gutter">
        <div class="col-sm-12">
          <div class="work-1">
            <img src="img/interstellar/0.jpg" class="img-full-width" alt="" />
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="left-work">
            <h2 class="work-para">
              <p class="work-head">Interstellar</p>
              An interactive storytelling of the movie Interstellar held online to
              provide an immersive experience. Developed with the user in mind.
            </h2>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="right-work">
            ...
            <img class="work-2" src="../img/interstellar/head.jpg" />
          </div>
        </div>

        <div class="col-sm-12">
          <div class="work-1">
            <img src="img/interstellar/1.jpg" class="img-full-width" alt="" />
          </div>
        </div>

        <div class="col-sm-12">
          <div class="work-1">
            <img src="img/interstellar/2.jpg" class="img-full-width" alt="" />
          </div>
        </div>
        <div class="col-sm-12">
          <div align="center" class="socialbtns">
            <ul>
              <li>
                <a href="/img/interstellar/Visual-Document.pdf">
                  <div id="contact-icon">
                    <p class="pcontact">Visual Document</p>
                  </div>
                </a>
              </li>
            </ul>
