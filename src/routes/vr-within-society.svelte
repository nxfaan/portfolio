    ...
    <div class="container-fluid full-width">
      <div class="row row-no-gutter">
        <div class="col-sm-12">
          <div class="work-1">
            <img
              src="img/VR-within-society/1.jpg"
        ...
        <div class="col-sm-6">
          <div class="left-work">
            <h2 class="work-para">
              <p class="work-head">VR within Society</p>
              Research Poster developed to portray research findings of the idea
              of introducing virtual reality systems into society within a creative
              output.
            </h2>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="right-work">
            ...
            <img class="work-2" src="/img/VR-within-society/head.jpg" />
          </div>
        </div>
        ...
        <div class="col-sm-12">
          <div class="work-1">
            <img
              src="img/VR-within-society/3.jpg"
              class="img-full-width"
              alt=""
            />
          </div>
        ...
        <div class="col-sm-12">
          <div align="center" class="socialbtns">
            <ul>
              <li>
                <a href="/img/VR-within-society/Research.pdf">
                  <div id="contact-icon">
                    <p class="pcontact">Research Poster</p>
                  </div>
                </a>
              </li>
            </ul>
