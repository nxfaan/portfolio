      ...
      <div class="row row-no-gutter">
        ...
        <div class="col-sm-12">
          <div align="center" class="socialbtns">
            <ul>
              <li>
                <a href="/img/lockdown/productionlog.pdf">
                  <div id="contact-icon">
              ...
              <li>
                <a href="/img/lockdown/exegisis.pdf">
                  <div id="contact-icon">
                    <p class="pcontact">Exegisis</p>
                  </div>
                </a>
              </li>
            </ul>
