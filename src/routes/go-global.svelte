  ...
  <div class="animate-in">
    <div class="container-fluid full-width">
      <div class="row row-no-gutter">
        <div class="col-sm-12">
          <div class="work-1">
            <img src="img/go-global/0.jpg" class="img-full-width" alt="" />
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="left-work">
            <h2 class="work-para">
              <p class="work-head">Go Global</p>
              Print and Digital marketing for Go Global week 2020. Digital assets
              produced for print and screens to promote travelling internationally
              to students.
            </h2>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="right-work">
            ...
            <img class="work-2" src="/img/go-global/head.jpg" />
          </div>
        </div>

        <div class="col-sm-12">
          <div class="work-1">
            <img src="img/go-global/1.jpg" class="img-full-width" alt="" />
          </div>
        </div>

        <div class="col-sm-12">
          <div class="work-1">
            <img src="img/go-global/2.jpg" class="img-full-width" alt="" />
          </div>
        </div>

        <div class="col-sm-12">
          <div class="work-1">
            <img src="img/go-global/3.jpg" class="img-full-width" alt="" />
          </div>
        </div>
      </div>
      <br />
