  ...
  <div class="animate-in">
    <div class="container-fluid full-width">
      <div class="row row-no-gutter">
        <div class="col-sm-12">
          <div class="work-1">
            <img src="img/dead-or-alive/0.jpg" class="img-full-width" alt="" />
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="left-work">
            <h2 class="work-para">
              <p class="work-head">Dead or Alive</p>
              A transmedia experience around the movie Of Mice and Men with the narrative
              leading towards finding Lennie after the conclusion of the movie.
            </h2>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="right-work">
            ...
            <img class="work-2" src="../img/dead-or-alive/head.jpg" />
          </div>
        </div>

        <div class="col-sm-12">
          <div class="work-1">
            <img src="img/dead-or-alive/1.jpg" class="img-full-width" alt="" />
          </div>
        </div>
      </div>
      <br />
          ...
          <div class="video">
            <div class="spotify-embeds">
              <div class="spotify-embed">
                <!-- svelte-ignore a11y-missing-attribute -->
                <iframe
                  src="https://player.vimeo.com/video/509874900"
                  width="640"
                  height="360"
                  frameborder="0"
      ...
      <div class="col-sm-12">
        <div align="center" class="socialbtns">
          <ul>
            <li>
              <a href="/img/dead-or-alive/deck.pdf">
                <div id="contact-icon">
                  <p class="pcontact">Design Deck</p>
                </div>
              </a>
            </li>
          </ul>
