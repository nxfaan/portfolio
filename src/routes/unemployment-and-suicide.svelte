    ...
    <div class="container-fluid full-width">
      <div class="row row-no-gutter">
        <div class="col-sm-12">
          <div class="work-1">
            <img
              src="img/unemployment-and-suicide/1.jpg"
        ...
        <div class="col-sm-6">
          <div class="left-work">
            <h2 class="work-para">
              <p class="work-head">Unemployment and Suicide</p>
              Using design to translate data into infographics that compare profession
              to the suicide rate in Northern Ireland.
            </h2>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="right-work">
            ...
            <img class="work-2" src="/img/unemployment-and-suicide/head.jpg" />
          </div>
        </div>
        ...
        <div class="col-sm-12">
          <div class="work-1">
            <img
              src="img/unemployment-and-suicide/2.jpg"
              class="img-full-width"
              alt=""
            />
          </div>
        ...
        <div class="col-sm-12">
          <div align="center" class="socialbtns">
            <ul>
              <li>
                <a href="/img/unemployment-and-suicide/visual.pdf">
                  <div id="contact-icon">
